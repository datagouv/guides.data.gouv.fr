---
description: >-
  Référencez votre cas d'usage de données en créant une collection et donnez lui
  en visibilité
---

# Ajouter une collection

### Qui peut publier une collection ?
...
<figure><img src="../../.gitbook/assets/ajouter_collection_bouquet (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../../.gitbook/assets/ajouter_collection (1) (2).png" alt=""><figcaption></figcaption></figure>

**Sujet**

Un bon sujet doit **refléter clairement l’usage de la collection** et **faciliter sa découverte** par les utilisateurs. Il ne s’agit pas simplement du nom du projet, mais d’une formulation qui explique **ce que la collection permet de faire**.

Critères clés :

* Précis : indiquer le thème central (et la zone géographique si pertinente).
* Actionnable : mettre en avant l’usage (ex : identification, suivi, etc.).
* Compréhensible : utiliser un langage clair, même pour un public non expert.

Exemple :

> _« Identification des potentiels fonciers adaptés aux projets par filières photovoltaïques | Bouches-du-Rhône »_\
> Ce titre précise l’objectif (identifier des potentiels fonciers), la filière (photovoltaïque) et la zone concernée (Bouches-du-Rhône).

À éviter :

* Les titres trop génériques (ex : _« Données énergétiques »_).
* Les acronymes ou jargon non expliqué.

**Objectif**

Dans l'encadré dédié à l'objectif de votre collection, il est recommandé de suivre le modèle suivant afin de favoriser la compréhension et la réutilisation de la collection par d'autres utilisateurs.

{% hint style="success" %}
1. **Présentation**\
   \&#xNAN;_Dans quels enjeux, objectifs ou politique publique s'inscrit cette_ collection \_ ? Quelles décisions l'initiative associée à la\_ collection _cherche-t-elle à éclairer ? Quelles sont les solutions proposées ?_
2. **Public cible**\
...
Chaque collection peut être associée à l’une des 6 thématiques clés définies par le Secrétariat Général de la planification écologique du plan **France Nation Verte**. Pour en savoir plus sur le plan France Nation Verte :

{% embed url="https://www.info.gouv.fr/grand-dossier/france-nation-verte" %}

**Couverture territoriale**

La couverture territoriale, bien que facultative, est fortement recommandée car elle facilite la **recherche des données par zone géographique**. Vous pouvez renseigner un niveau parmi les suivants : pays, région, département, commune ou EPCI.

**Propriétaire de la collection thématique**

Vous devez choisir de publier la collection en votre propre nom ou en tant qu'organisation.

{% hint style="info" %}
Si vous vous inscrivez dans le cadre d’une organisation, tous les membres de l'organisation pourront éditer la collection.
{% endhint %}
...
<figure><img src="../../.gitbook/assets/accueil_collection (1) (2).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/ajouter_jdd (2) (2).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/publier (2).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/modifier (2).png" alt=""><figcaption></figcaption></figure>
