---
cover: ../../.gitbook/assets/Gitbook bandereau6 (1) (1).png
coverY: 0
---
...
{% file src="../../.gitbook/assets/GT CNIG - Modèle de standard (1) (1) (1).docx" %}
_Modèle de standard_
{% endfile %}

### Modèle de compte rendu de réunion

{% file src="../../.gitbook/assets/GT CNIG - Modèle de CR de réunion (1) (1) (1).docx" %}
