---
cover: ../../.gitbook/assets/Bandereau87 (1) (1).png
coverY: 0
---
...
La démarche à suivre est détaillée dans [une page dédiée](realiser-un-appel-a-commentaires.md).
{% endstep %}
...
{% file src="../../.gitbook/assets/GT CNIG - Modèle de dossier de présentation au plénier (1) (1).docx" %}
