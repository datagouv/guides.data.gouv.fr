...
* Annoncer l'appel à commentaires en commission des standards et au sein du CNIG (secrétariat général, GT et Commissions concernées par le standard). Il est aussi recommandé de réaliser un point d’avancement en commission des standards avant l’appel à commentaires, en se concentrant sur les points suivants :&#x20;
  * Un rappel de la composition du groupe de travail et de l'implication des parties prenantes ;
  * Une retrospective sur le travail réalisé dans ses grandes lignes (réunions, sous-groupes créés le cas échéant, etc.) ;
  * Une présentation du projet de standard, sans rentrer dans le détail technique ;&#x20;
  * Le détail des modalités envisagées pour l'appel à commentaire (collecte des retours, organisation pour le traitement de ces retours, etc.).
{% endstep %}
