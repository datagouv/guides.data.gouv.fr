...
* [💎 Guide qualité](guides/guide-qualite/README.md)
  ...
  * [Les schémas de données](guide-qualite/les-schemas-de-donnees/README.md)
    ...
    * [Intégrer un schéma de données à schema.data.gouv.fr](guides/guide-qualite/les-schemas-de-donnees/integrer-un-schema-de-donnees-a-schema.data.gouv.fr/README.md)
      * [Qui peut référencer des schémas de données ?](guides/guide-qualite/les-schemas-de-donnees/integrer-un-schema-de-donnees-a-schema.data.gouv.fr/qui-peut-referencer-des-schemas-de-donnees.md)
      * [Quels schémas de données sont acceptés ?](guides/guide-qualite/les-schemas-de-donnees/integrer-un-schema-de-donnees-a-schema.data.gouv.fr/quels-schemas-de-donnees-sont-acceptes.md)
      * [Quand référencer un schéma de données ?](guides/guide-qualite/les-schemas-de-donnees/integrer-un-schema-de-donnees-a-schema.data.gouv.fr/quand-referencer-un-schema-de-donnees.md)
      * [Comment référencer un schéma de données ?](guides/guide-qualite/les-schemas-de-donnees/integrer-un-schema-de-donnees-a-schema.data.gouv.fr/comment-referencer-un-schema-de-donnees.md)
    * [Indiquer qu'une ressource respecte un schéma de données](guides/guide-qualite/les-schemas-de-donnees/indiquer-quune-ressource-respecte-un-schema-de-donnees.md)
