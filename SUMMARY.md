...
* [💎 Guide qualité](guides/guide-qualite/README.md)
  ...
  * [Les schémas de données](guide-qualite/les-schemas-de-donnees/README.md)
    * [Comprendre les bénéfices d'utiliser un schéma de données](guides/guide-qualite/les-schemas-de-donnees/comprendre-les-benefices-dutiliser-un-schema-de-donnees.md)
    ...
    * [S'intégrer avec schema.data.gouv.fr](guide-qualite/les-schemas-de-donnees/integration-avec-schema.data.gouv.fr.md)
      * [Qui peut référencer des schémas ?](guides/guide-qualite/les-schemas-de-donnees/sintegrer-avec-schema.data.gouv.fr/qui-peut-referencer-des-schemas.md)
    ...
    * [Indiquer qu'une ressource respecte un schéma](guide-qualite/les-schemas-de-donnees/jeux-de-donnees-sur-data.gouv.fr-et-schemas.md)
