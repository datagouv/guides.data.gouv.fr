...
<figure><img src="../../.gitbook/assets/Capture d’écran 2023-09-04 à 18.39.07 (2).png" alt=""><figcaption><p>Validateur BAL</p></figcaption></figure>

2. Suivez ensuite la [procédure standard de publication de données sur data.gouv.fr](https://github.com/datagouv/guides.data.gouv.fr/blob/main/broken/pages/THaWx8YnNzHJDxnuPXJp/README.md#directement-sur-data.gouv.fr), en veillant à **ajouter le mot clé "base-adresse-locale".**
...
<figure><img src="../../.gitbook/assets/Sep-04-2023 18-35-27 (2).gif" alt=""><figcaption><p>Interface de l'éditeur "Mes Adresses"</p></figcaption></figure>
