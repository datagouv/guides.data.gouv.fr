---
description: Comprendre le rôle du skill data.gouv.fr et savoir dans quels cas l’utiliser.
icon: markdown
---
...
* [**MCP**](https://github.com/datagouv/datagouv-mcp) : orchestrer l’usage via des outils intégrés au flux de l’assistant.
