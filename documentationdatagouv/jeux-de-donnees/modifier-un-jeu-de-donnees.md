...
* Cliquez sur <img src="../.gitbook/assets/image (56) (1).png" alt="" data-size="line">
...
{% hint style="info" %}
Vous pouvez aussi accéder à la modification de votre jeu de données directement depuis la page publique de celle-ci en cliquant sur le bouton <img src="../.gitbook/assets/image (49) (1).png" alt="" data-size="line">.
{% endhint %}
