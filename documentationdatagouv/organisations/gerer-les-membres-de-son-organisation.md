...
2. Cliquez sur <img src="../../.gitbook/assets/image (1) (5).png" alt="" data-size="line"> en haut à droite de votre écran ;
3. Dans la colonne de gauche, cliquez sur le nom de votre organisation ;
4. Cliquez sur <img src="../../.gitbook/assets/image (2) (4).png" alt="" data-size="line">, dans le menu latéral de votre organisation ;
5. Cliquez sur le bouton <img src="../../.gitbook/assets/image (4) (4).png" alt="" data-size="line">
...
5.  Vous verrez apparaitre les demandes d'adhésions
    ...
    <figure><img src="../../.gitbook/assets/image (5) (4).png" alt=""><figcaption><p>Exemple de demande</p></figcaption></figure>
...
3. Dans la colonne de gauche, cliquez sur le nom de votre organisation ;
4. Cliquez sur <img src="../../.gitbook/assets/image (2) (4).png" alt="" data-size="line">, dans le menu latéral de votre organisation ;
5. Dans le tableau de membres cliquez sur le crayon <img src="../../.gitbook/assets/image (6) (3).png" alt="" data-size="line">dans la colonne **Actions.**
