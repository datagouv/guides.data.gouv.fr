...
* Cliquez sur <img src="../.gitbook/assets/image (52) (2).png" alt="" data-size="line">
...
{% hint style="info" %}
Vous pouvez aussi accéder à la modification de votre API directement depuis la page publique de celle-ci en cliquant sur le bouton <img src="../.gitbook/assets/image (49) (2).png" alt="" data-size="line">.
{% endhint %}
...
#### Onglet _Jeux de données associés_
