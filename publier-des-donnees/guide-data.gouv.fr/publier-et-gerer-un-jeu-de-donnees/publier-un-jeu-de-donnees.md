...
Plusieurs modes de mises en ligne sont possibles sur data.gouv.fr :&#x20;
...
{% hint style="info" %}
En amont de la publication de données sur data.gouv.fr, il est important de bien préparer le jeu de données (cf. [guide qualité](../../../guides/guide-qualite/)).
{% endhint %}
...
**Pour en savoir plus consulter le** [**guide API**](../../../utiliser-data.gouv.fr/api/)**.**
{% endtab %}
