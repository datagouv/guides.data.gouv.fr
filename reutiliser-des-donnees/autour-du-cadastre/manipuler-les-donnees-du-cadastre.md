...
- **la version d'Etalab**
    ...
    - Cette version étant dépendante de la version précédente mais nécessitant plus de traitement, elle requiert plusieurs semaines opur sa mise à disposition, à partir de la réception des données transmises par la DGFiP. 
...
- **Pour la version de l'IGN** : [la page "PARCELLAIRE EXPRESS (PCI)" du site Geoservices IGN](https://geoservices.ign.fr/parcellaire-express-pci).
...
**Pour réaliser une intégration métier parcelles et MAJIC, plusieurs solutions sont à disposition :**
