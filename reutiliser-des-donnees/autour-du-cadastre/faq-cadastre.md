...
Merci de vous référer à [cette partie relative à la réutilisation des données](../reutiliser-des-donnees/manipuler-les-donnees-du-cadastre.md#decalage-parcelles).
