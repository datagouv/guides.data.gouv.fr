...
<figure><img src="../../../.gitbook/assets/Apr-28-2023 16-39-21 (1).gif" alt=""><figcaption><p>Echantillon de discussions sur le jeu de données "Demandes de valeur foncière"</p></figcaption></figure>

* **Suivre les réutilisations ajoutées sur ses jeux de données sur data.gouv.fr et inciter au référencement.**

<figure><img src="../../../.gitbook/assets/Apr-28-2023 16-42-05 (1).gif" alt=""><figcaption><p>Consultation des réutilisations références sur le jeu de données "Prix des carburants - Flux instantané"</p></figcaption></figure>
