...
{% hint style="info" %}
Les préconisations pour structurer une Base Adresse Locale sont détaillées sur [cette page](structurer-une-base-adresse-locale.md).
{% endhint %}
...
<figure><img src="../../../../.gitbook/assets/Capture d’écran 2023-06-19 à 17.16.56 (2).png" alt=""><figcaption><p>Page d'accueil de publier.etalab.studio</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Capture d’écran 2023-04-25 à 18.05.30 (1) (6).png" alt=""><figcaption><p>Schéma synthétisant la procédure pour saisir, valider et publier des données à l'aide de publier.etalab.studio</p></figcaption></figure>
