...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/nSrS1oz2N9yTlykjBxxZ/autres-ressources-utiles/donnees-de-forte-valeur-modalites-de-rapportage
---
...
2. Les données ainsi identifiées remontent au niveau national en étant :
   * soit moissonnées sur [data.gouv.fr](http://data.gouv.fr/) (cf. [Moissonnage](/broken/pages/bfvw92bC3fdl8SM6760u)) et éventuellement le [geocatalogue](https://www.geocatalogue.fr/) selon leur nature ;
